...
class DatabaseManager {
    ...
    // predictions
    fileprivate var itemClassifierPredictiveModel = ItemClassifierPredictiveModel.init()
    ...
    deinit {
        ...
        do {
            ...
            itemClassifierPredictiveModel.unregisterModel()
            try self._db?.close()
        }
        catch  {
...
extension DatabaseManager {
    ...
    func registerPredictionModel() {
        print(#function)
        itemClassifierPredictiveModel.registerModel()
    }
    ...
    // For searches on type property
        ...
        let model = ItemClassifierPredictiveModel.name
...
extension DatabaseManager {
    func useRegisteredModelToFindMatchingItemsInDBToInputImage(_ imageData:Data, imageName:String, propertyName:String)->(userRecords:[UserRecord]?,status:Bool) {
            ...
            let modelName = ItemClassifierPredictiveModel.name
